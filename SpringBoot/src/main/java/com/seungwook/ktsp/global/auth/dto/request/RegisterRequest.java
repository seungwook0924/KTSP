...
public class RegisterRequest {
    ...
    public RegisterRequest(String email, String password, String studentNumber, String name, AcademicYear academicYear, String telNumber, String major, BigDecimal previousGpa) {
        this.email = email;
